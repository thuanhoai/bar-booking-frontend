...
export default function TopBarsDaNang() {
    ...
    useEffect(() => {
        ...
        barApi.getBars().then((data) => {
            ...
            const daNangBars: RankedBar[] = data
                .filter(bar => bar.city === "Đà Nẵng")
                .sort((a, b) => {
                    // ưu tiên partner
    ...
    if (!bars.length) {
        return (
            <div className="text-center my-5 text-muted">
                Chưa có quán bar nổi bật tại Đà Nẵng
            </div>
        )
    }
        ...
        <section className="container my-5">
            ...
            <div className="d-flex justify-content-between align-items-center mb-3">
                <h2 className="fw-bold mb-0">
                    🔥 Top quán bar tại Đà Nẵng
                </h2>

                <button
                    className="btn btn-outline-primary btn-sm"
                    onClick={() => navigate("/bars?city=Đà Nẵng")}
                >
                    Xem tất cả
                </button>
            </div>
            ...
            <Swiper
                ...
                breakpoints={{
                    ...
                    992: { slidesPerView: 4 },
                    1200: { slidesPerView: 4 }, // desktop luôn 4 card
                }}
            >
                {bars.map((bar) => {
